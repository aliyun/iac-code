...
_MODEL_EXACT_CONFIGS: dict[str, ContextWindowConfig] = {
    "claude-fable-5-1": _context_config(1_000_000, 128_000),
    ...
    "gemini-3.8-flash": _context_config(1_048_576, 65_536),
    "gemini-3.7-flash": _context_config(1_048_576, 65_536),
    ...
    "k3": _context_config(1_048_576),
    "k3-256k": _context_config(262_144),
    "kimi-for-coding": _context_config(1_048_576),
    "kimi-for-coding-highspeed": _context_config(262_144),
    "qwen3.8-max": _context_config(1_000_000, 128_000),
    "qwen3.8-max-0902": _context_config(1_000_000, 128_000),
    "qwen3.8-max-prime": _context_config(1_000_000, 128_000),
    "qwen3.8-flash": _context_config(1_000_000, 128_000),
    ...
    "deepseek-flash": _context_config(1_000_000, 393_216),
    ...
    "deepseek-v4.1-flash": _context_config(1_000_000, 393_216),
    ...
    "zhipu/glm-5.3-flash": _context_config(1_048_576, 131_072),
    ...
    "minimax/minimax-m2.7": _context_config(196_608),
