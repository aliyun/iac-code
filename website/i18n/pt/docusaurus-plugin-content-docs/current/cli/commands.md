...
| `/memory` | Abre o seletor de memória. Edite os arquivos `IAC-CODE.md` de projeto ou usuário, ative ou desative auto-memory e abra a pasta de auto-memory do projeto quando auto-memory estiver ativada. |
...
- A memória do projeto é salva em `IAC-CODE.md` na raiz do projeto.
- A memória do usuário é salva em `IAC-CODE.md` no diretório de configuração em tempo de execução, `~/.iac-code/` por padrão.
