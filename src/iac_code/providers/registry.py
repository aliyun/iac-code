...
PROVIDER_REGISTRY: dict[str, ProviderDescriptor] = {
    "dashscope": ProviderDescriptor(
        ...
        models=[
            ...
            ModelEntry("qwen3.5-flash", support_multimodal=True),
            ModelEntry("qwen-plus"),
            ModelEntry("qwen-flash"),
            ModelEntry("qwq-plus"),
            ...
            ModelEntry("kimi-k2.7-code", support_multimodal=True),
    ...
    "openai": ProviderDescriptor(
        ...
        models=[
            ...
            ModelEntry("gpt-5.6-luna", support_multimodal=True),
            ModelEntry("gpt-5.5", support_multimodal=True),
            ModelEntry("gpt-5.4", support_multimodal=True),
            ModelEntry("gpt-5.4-mini", support_multimodal=True),
            ModelEntry("gpt-5.4-nano", support_multimodal=True),
    ...
    "gemini": ProviderDescriptor(
        ...
        models=[
            ModelEntry("gemini-3.6-flash", is_default=True, support_multimodal=True),
            ModelEntry("gemini-3.5-flash", support_multimodal=True),
            ModelEntry("gemini-3.5-flash-lite", support_multimodal=True),
            ModelEntry("gemini-3.1-pro-preview", support_multimodal=True),
            ModelEntry("gemini-3.1-pro-preview-customtools", support_multimodal=True),
    ...
    "kimi_cn": ProviderDescriptor(
        ...
        models=[
            ModelEntry("kimi-k3", is_default=True, support_multimodal=True),
            ModelEntry("kimi-k2.7-code", support_multimodal=True),
            ModelEntry("kimi-k2.7-code-highspeed", support_multimodal=True),
            ModelEntry("kimi-k2.6", support_multimodal=True),
            ModelEntry("kimi-k2.5", support_multimodal=True),
        ],
    ...
    "minimax_cn": ProviderDescriptor(
        ...
        models=[
            ModelEntry("MiniMax-M3", is_default=True, support_multimodal=True),
    ...
    "zhipu_cn": ProviderDescriptor(
        ...
        models=[
            ...
            ModelEntry("glm-5"),
            ModelEntry("glm-4.7"),
            ModelEntry("glm-4.7-flash"),
            ModelEntry("glm-4.7-flashx"),
            ModelEntry("glm-4.6"),
            ModelEntry("glm-4.5"),
            ModelEntry("glm-4.5-air"),
            ModelEntry("glm-4.5-x"),
            ModelEntry("glm-4.5-airx"),
            ModelEntry("glm-4.5-flash"),
        ],
    ...
    "azure_openai": ProviderDescriptor(
        ...
        base_url=None,
        # Azure requests use the deployment name, which is user-defined and
        # cannot be inferred from the public OpenAI model catalog.
        models=[],
