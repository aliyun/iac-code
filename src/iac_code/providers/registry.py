...
PROVIDER_REGISTRY: dict[str, ProviderDescriptor] = {
    ...
    "openai": ProviderDescriptor(
        ...
        models=[
            ...
            ModelEntry("gpt-5.5-pro", support_multimodal=True),
            ModelEntry("gpt-5.4", support_multimodal=True),
            ModelEntry("gpt-5.4-pro", support_multimodal=True),
    ...
    "anthropic": ProviderDescriptor(
        ...
        base_url=None,
        models=[
            ModelEntry("claude-opus-4-8", is_default=True, support_multimodal=True),
    ...
    "kimi_cn": ProviderDescriptor(
        ...
        models=[
            ModelEntry("kimi-k2.7-code", is_default=True, support_multimodal=True),
            ModelEntry("kimi-k2.6", support_multimodal=True),
            ModelEntry("kimi-k2.5", support_multimodal=True),
        ],
    ...
    "azure_openai": ProviderDescriptor(
        ...
        models=[
            ...
            ModelEntry("gpt-5.4-nano", support_multimodal=True),
            ModelEntry("gpt-5.3-codex", support_multimodal=True),
            ModelEntry("gpt-5.2-codex", support_multimodal=True),
            ModelEntry("gpt-5.2", support_multimodal=True),
        ],
