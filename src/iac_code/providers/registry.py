...
PROVIDER_REGISTRY: dict[str, ProviderDescriptor] = {
    "dashscope": ProviderDescriptor(
        ...
        models=[
            ModelEntry("qwen3.8-max-0902", is_default=True, support_multimodal=True),
            ModelEntry("qwen3.8-max", support_multimodal=True),
            ...
            ModelEntry("deepseek-v4.1-flash", support_multimodal=True),
            ModelEntry("deepseek-v4-pro"),
            ModelEntry("deepseek-v4-pro-0813"),
            ...
            ModelEntry("MiniMax/MiniMax-M2.1"),
    ...
    "openai": ProviderDescriptor(
        ...
        base_url=None,
        models=[
            # GPT-6 Astra requires the Responses API for tool calling. Keep the
            # Chat-Completions-based iac-code adapter on GPT-5.6 Sol by default.
            ModelEntry("gpt-6-astra", support_multimodal=True),
    ...
    "anthropic": ProviderDescriptor(
        ...
        base_url=None,
        models=[
            ModelEntry("claude-fable-5-1", is_default=True, support_multimodal=True),
            ModelEntry("claude-fable-5", support_multimodal=True),
    ...
    "gemini": ProviderDescriptor(
        ...
        models=[
            ModelEntry("gemini-3.8-flash", is_default=True, support_multimodal=True),
            ModelEntry("gemini-3.7-flash", support_multimodal=True),
            ModelEntry("gemini-3.6-flash", support_multimodal=True),
    ...
    "kimi_code": ProviderDescriptor(
        ...
        models=[
            ModelEntry("kimi-for-coding", is_default=True, support_multimodal=True),
            ModelEntry("k3", support_multimodal=True),
            ModelEntry("k3-256k", support_multimodal=True),
            ModelEntry("kimi-for-coding-highspeed", support_multimodal=True),
        ],
        qwenpaw_provider_ids=["kimi-code"],
    ),
...
PROVIDER_GROUPS: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("Kimi", ("kimi_code", "kimi_cn", "kimi_intl")),
