...
rule_meta := {
    ...
    "reason": {
        ...
        "ja": "RDS 实例必须设置付费类型未满足。",
        "de": "RDS 实例必须设置付费类型未满足。",
        "es": "RDS 实例必须设置付费类型未满足。",
        "fr": "RDS 实例必须设置付费类型未满足。",
        "pt": "RDS 实例必须设置付费类型未满足。"
    },
    "recommendation": {
        "en": "Configure PayType on ALIYUN::RDS::DBInstance to satisfy the policy.",
        "zh": "请在 ALIYUN::RDS::DBInstance 上配置 PayType 以满足策略。",
        "ja": "请在 ALIYUN::RDS::DBInstance 上配置 PayType 以满足策略。",
        "de": "请在 ALIYUN::RDS::DBInstance 上配置 PayType 以满足策略。",
        "es": "请在 ALIYUN::RDS::DBInstance 上配置 PayType 以满足策略。",
        "fr": "请在 ALIYUN::RDS::DBInstance 上配置 PayType 以满足策略。",
        "pt": "请在 ALIYUN::RDS::DBInstance 上配置 PayType 以满足策略。"
    },
