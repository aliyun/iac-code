...
def log_session_started(
    *,
    ...
    thinking_phase_timeout: float | None = None,
    ...
    fields: dict[str, Any] = {
        ...
        "thinking_phase_timeout": thinking_phase_timeout,
        "max_turns": max_turns,
...
def log_session_started_from_provider_settings(
    *,
    ...
    log_session_started(
        ...
        thinking_phase_timeout=_float_or_none(provider_settings.get("thinking_phase_timeout")),
        max_turns=max_turns,
        tool_count=tool_count,
        mcp_server_count=mcp_server_count,
        permission_mode=permission_mode,
